...
<p>
    {l s='If you have any question please contact us on our phone' mod='placetopaypayment'} {$storePhone}
    {l s='or using our email' mod='placetopaypayment'} {mailto address=$storeEmail}
</p>
...
<p>
    <a href='javascript:window.print()'>
        <img src="{$placetopayImgUrl}b_print.png" alt="{l s='Print' mod='placetopaypayment'}" width="32" height="32"
             border="0"/>
