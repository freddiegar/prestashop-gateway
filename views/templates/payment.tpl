<p class="payment_module">
	{if $hasPending}
		...
		<a class="placetopay">
			<img src="https://www.placetopay.com/images/providers/placetopay_xh48.png" alt="{l s='Pay with Place to Pay' mod='placetopaypayment'}" />
			...
			{if $cifinmessage}
				<span>
					...
					<small>
						{l s=', generating a ' mod='placetopaypayment'}<u>{l s='consultation trace.' mod='placetopaypayment'}</u>
					</small>
				</span>
			{/if}
		</a>
	...
	{else}
		...
		<a class="placetopay" href="{$base_dir_ssl}modules/{$module}/redirect.php" title="{l s='Pay with Place to Pay' mod='placetopaypayment'}">
			<img src="https://www.placetopay.com/images/providers/placetopay_xh48.png" alt="{l s='Pay with Place to Pay' mod='placetopaypayment'}" />
			<b>
