    ...
    <form enctype="multipart/form-data" method="post" action="{$actionURL}">
        <fieldset>
            ...
            <div class="margin-form">
                <input class="form-control" type="text" id="companydocument" name="companydocument"
                       value="{$companydocument}" width="120" autocomplete="off"/>
            </div>

            <label class="control-label" for="companyname">{l s='Company Name' mod='placetopaypayment'}</label>
            <div class="margin-form">
                <input class="form-control" type="text" id="companyname" name="companyname" value="{$companyname}"
        ...
        <fieldset>
            ...
            <div class="margin-form">
                <select class="form-control" id="environment" name="environment">
                    <option value="PRODUCTION"
                            {if $environment eq 'PRODUCTION'}selected="selected"{/if}>{l s='Production' mod='placetopaypayment'}</option>
                    <option value="TEST"
                            {if $environment eq 'TEST'}selected="selected"{/if}>{l s='Test' mod='placetopaypayment'}</option>
                    <option value="DEVELOPMENT"
                            {if $environment eq 'DEVELOPMENT'}selected="selected"{/if}>{l s='Development' mod='placetopaypayment'}</option>
                </select>
            </div>
            ...
            <div class="margin-form">
                <select class="form-control" id="cifinmessage" name="cifinmessage">
                    <option value="1"
                            {if $cifinmessage eq '1'}selected="selected"{/if}>{l s='Yes' mod='placetopaypayment'}</option>
                    <option value="0"
                            {if $cifinmessage ne '1'}selected="selected"{/if}>{l s='No' mod='placetopaypayment'}</option>
                </select>
            </div>

            <label class="control-label"
                   for="stockreinject">{l s='Reinject stock on declination?' mod='placetopaypayment'}</label>
            <div class="margin-form">
                <select class="form-control" id="stockreinject" name="stockreinject">
                    <option value="1"
                            {if $stockreinject eq '1'}selected="selected"{/if}>{l s='Yes' mod='placetopaypayment'}</option>
                    <option value="0"
                            {if $stockreinject ne '1'}selected="selected"{/if}>{l s='No' mod='placetopaypayment'}</option>
                </select>
            </div>
            ...
            <div class="margin-form">
                ...
                <a href="{$actionBack}"><input class="btn btn-default" type="button"
                                               value="{l s='Back to list' mod='placetopaypayment'}" name="return"/></a>
            </div>
